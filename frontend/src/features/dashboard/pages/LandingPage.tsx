...
import LandingNavbar from '@/features/dashboard/components/LandingNavbar'; // ✅ Usamos el Navbar nuevo
import GridPattern from '@/shared/components/ui/GridPattern';
import HeroDashboard from '@/features/dashboard/components/HeroDashboard'; // Asegúrate que este archivo exista o usa HeroImageSVG de abajo
import { IconAI, IconSpeed, IconCloud, IconUpload, IconAnalyze, IconResult } from '../components/LandingVisuals';

export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen overflow-hidden bg-slate-950 font-sans text-slate-300 selection:bg-purple-500 selection:text-white relative">
      
      {/* ==========================================
          FONDO ANIMADO GLOBAL
      ========================================== */}
      <div className="fixed inset-0 -z-10">
          <div className="absolute top-0 left-0 right-0 h-[500px] bg-purple-900/20 blur-[120px] rounded-full mix-blend-screen pointer-events-none opacity-50" />
          <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-indigo-900/10 blur-[100px] rounded-full mix-blend-screen pointer-events-none opacity-30" />
          <div className="absolute inset-0 opacity-20">
            <GridPattern />
          </div>
      </div>

      {/* ✅ NAVBAR PÚBLICO (No da error de login) */}
      <LandingNavbar />
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-300 text-xs font-medium mb-8 backdrop-blur-md animate-fade-in-down">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a href="#features" className="inline-flex items-center justify-center px-8 py-4 font-medium text-slate-300 transition-all duration-200 bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-full hover:text-white hover:bg-slate-800">
                Ver Demo
              </a>
            </div>
          </div>
          <div className="relative max-w-5xl mx-auto rounded-2xl p-2 bg-gradient-to-b from-slate-700/50 to-transparent backdrop-blur-sm aspect-[16/9] md:aspect-[16/8]">
             <HeroDashboard /> 
             <div className="absolute -inset-4 bg-purple-500/20 blur-3xl -z-10 rounded-[3rem] opacity-50" />
          </div>
      ...
      <section id="how-it-works" className="py-24 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
                {/* Línea conectora */}
                <div className="hidden md:block absolute top-12 left-[15%] right-[15%] h-0.5 bg-gradient-to-r from-transparent via-slate-700 to-transparent -z-10" />
                ...
                <div className="relative flex flex-col items-center text-center group">
                    ...
                    <p className="text-slate-400 text-sm px-4">Toma una foto de la hoja afectada con tu celular o súbela desde tu PC.</p>
                </div>
                ...
                <div className="relative flex flex-col items-center text-center group">
                    ...
                    <p className="text-slate-400 text-sm px-4">Nuestros algoritmos procesan la imagen en la nube en milisegundos.</p>
                </div>
                ...
                <div className="relative flex flex-col items-center text-center group">
                    ...
                    <p className="text-slate-400 text-sm px-4">Recibe el diagnóstico y una guía de tratamiento certificada.</p>
                </div>
            </div>
        </div>
      </section>
      ...
      {/* ==========================================
          FEATURES GRID
      ========================================== */}
      <section id="features" className="py-20 bg-slate-900/30 border-y border-slate-800/50 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-3 gap-8">
                <div className="p-8 bg-slate-800/40 rounded-3xl border border-slate-700/50 hover:bg-slate-800 transition-colors duration-300 group backdrop-blur-sm">
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed">Modelos entrenados para detectar enfermedades en Banano, Café y Arroz con alta precisión.</p>
                </div>
                <div className="p-8 bg-slate-800/40 rounded-3xl border border-slate-700/50 hover:bg-slate-800 transition-colors duration-300 group backdrop-blur-sm">
                    <div className="mb-4 text-cyan-400"><IconSpeed /></div>
                    <h3 className="text-xl font-bold text-white mb-3">Tiempo Real</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">No esperes días. Obtén resultados inmediatos y toma decisiones rápidas en campo.</p>
                </div>
                <div className="p-8 bg-slate-800/40 rounded-3xl border border-slate-700/50 hover:bg-slate-800 transition-colors duration-300 group backdrop-blur-sm">
                    <div className="mb-4 text-emerald-400"><IconCloud /></div>
                    <h3 className="text-xl font-bold text-white mb-3">Cloud History</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">Registro digital completo de la salud de todos tus lotes accesible desde cualquier lugar.</p>
                </div>
            </div>
        </div>
      </section>
      ...
      {/* ==========================================
          CTA FINAL
      ========================================== */}
      <section className="py-24 relative overflow-hidden z-10 text-center px-6">
      ...
      {/* FOOTER */}
      <footer className="py-12 border-t border-slate-800 bg-slate-950 relative z-10 px-6">
